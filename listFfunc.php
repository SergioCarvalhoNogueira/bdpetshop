...
<head>
    ...
    <title> # Lista de Funcao de Funcionario #</title>
    ...
    <div id="content">
        <div class="container">
			<br/><br/><br/><br/><br/>
				...
				$sql = pg_query("select ff.nome  from funcao ff where ff.idfuncao = ff.idfuncao");	 
				
				?>
			<table border="1">
				
				  <tr>
					 <td align="center" colspan="3">Funcao de Funcionario</td>		 
				  </tr>
				  <tr>
					 <th>Nome</th>					 					 
				  </tr> 
