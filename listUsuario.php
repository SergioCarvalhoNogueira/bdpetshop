    ...
    <div id="content">
        <div class="container">
			<br/><br/><br/><br/><br/>
				...
				$sql = pg_query("select u.login, tu.nome  from usuario u, tipo_usuario tu where u.idtipo_usuario = tu.idtipo_usuario");	 
				
				?>
			<table border="1">
				
				  <tr>
					 <td align="center" colspan="3">Usuarios</td>		 
				  </tr>
				  <tr>
					 <th>Nome</th>
					 <th>Tipo</th>
				  ...
				  <tr>
				  <?php while($usu = pg_fetch_array($sql)) {?>
