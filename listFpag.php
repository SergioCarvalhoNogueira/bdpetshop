    ...
    <div id="content">
        <div class="container">
			<br/><br/><br/><br/><br/>
				...
				$sql = pg_query("select fp.nome  from formadepagamento fp where fp.idformadepagamento = fp.idformadepagamento");	 
				
				?>
			<table border="1">
				
				  <tr>
					 <td align="center" colspan="3">Forma de pagamento</td>		 
				  </tr>
				  <tr>
					 <th>Nome</th>					 					 
				  </tr> 
				  <tr>
				  <?php while($fp = pg_fetch_array($sql)) {?>
					 <td><?php echo $fp['nome']; ?></td>					 
				  </tr>
			<?php }?>			
			</table>
        </div>
