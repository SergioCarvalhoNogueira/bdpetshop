...
<head>
    ...
    <title>## Cadastro Função de Funcionário ##</title>
    ...
    <div id="content">
		...
		<!-- AQUI COLOCA O CONTEUDO DA PAGINA!! O RESTO FICA TUDO IGUAL.  -->
			<center>
				...
				<form name="formFfunc" action="procCadFfunc.php" method="post">
					<table border="1">
					  <tr>
						 <th colspan="2" align="center">  Cadastro de Função de Funcionário </th>
					  </tr>
					  <tr>
						 <td>Nome:</td>
