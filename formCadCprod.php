...
<head>
    ...
    <title>## Cadastro Categoria Produto ##</title>
    ...
    <div id="content">
		...
		<!-- AQUI COLOCA O CONTEUDO DA PAGINA!! O RESTO FICA TUDO IGUAL.  -->
			<center>
				...
				<form name="formCprod" action="procCadCprod.php" method="post">
					<table border="1">
					  <tr>
						 <th colspan="2" align="center">  Cadastro de Categoria de Produto </th>
					  </tr>
					  <tr>
						 <td>Nome:</td>
