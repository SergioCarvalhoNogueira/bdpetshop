    ...
    <div id="content">
        <div class="container">
			<br/><br/><br/><br/><br/>
				...
				$sql = pg_query("select a.nome nome_ani , a.dono, e.nome nome_esp from animal a, especie e where e.idespecie = a.idespecie");	 
				
				?>
			<table border="1">
				
				  <tr>
					 <td align="center" colspan="3">Animais</td>		 
				  </tr>
				  <tr>
					 <th>Nome</th>
					 <th>Dono</th>	
				  ...
				  <?php while($ani = pg_fetch_array($sql)) {?>
					 <td><?php echo $ani['nome_ani']; ?></td>
					 <td><?php echo $ani['dono']; ?></td>	
					 <td><?php echo $ani['nome_esp']; ?></td>
				  </tr>
			<?php }?>			
			</table>
        </div>
