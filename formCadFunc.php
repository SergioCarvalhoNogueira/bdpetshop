...
<body>
	...
	<?php   	
		...
		$sql = pg_query("select idfuncao, nome from funcao");	
	?>	
    <div id="content">
		<div class="container">
		<!-- AQUI COLOCA O CONTEUDO DA PAGINA!! O RESTO FICA TUDO IGUAL.  -->
			<center>
				...
				<form name="formCli" action="procCadFunc.php" method="post">
					...
					<table border="1">
					  ...
					  <tr>
						...
						<option>Selecione...</option>
						 <?php while($funcao = pg_fetch_array($sql)) { ?>
						 <option value="<?php echo $funcao['idfuncao'] ?>"><?php echo $funcao['nome'] ?></option>
						 <?php } ?>
						 </select>
						</td>
					  </tr>
