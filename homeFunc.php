    ...
    <header class="main">
        <nav class="green-gradient invert">
            <div class="container invert">
                <ul class="top-menu">
                    <li><a href="homeFunc.php">Home</a></li>                    
        ...
        <div class="container">
            <aside class="left">
                <div class="block">
                    ...
                    <ul>
						<li><a href="agendConsultaVet.php">Consulta Veterinária</a></li>
                        <li><a href="agendTosa.php">Tosa</a></li> 
						<li><a href="agendBanho.php">Banho</a></li> 
                    </ul>
                </div>
                <div class="block">
                    <header class="green-gradient">Produtos</header>
                    <ul>              
                        <li><a href="listRacoes.php">Rações</a></li>
                        <li><a href="listBrinq.php">Brinquedos</a></li>
                        <li><a href="listRoupas.php">Roupas</a></li>                        
                        <li><a href="listMed.php">Medicamentos</a></li>
                        <li><a href="listLinhaHig.php">Linha Higiênica</a></li>                                               
                    </ul>
                </div>
            </aside>
