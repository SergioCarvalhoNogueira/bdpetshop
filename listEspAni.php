...
<head>
    ...
    <title> # Lista de Especies de Animais #</title>
    ...
    <div id="content">
        <div class="container">
			<br/><br/><br/><br/><br/>
				...
				$sql = pg_query("select e.nome  from especie e where e.idespecie = e.idespecie");	 
				
				?>
			<table border="1">
				
				  <tr>
					 <td align="center" colspan="3">Especies de Animais</td>		 
				  </tr>
				  <tr>
					 <th>Nome</th>					 					 
				  </tr> 
				  <tr>
				  <?php while($eani = pg_fetch_array($sql)) {?>
					 <td><?php echo $eani['nome']; ?></td>					 
				  </tr>
			<?php }?>			
			</table>
        </div>
